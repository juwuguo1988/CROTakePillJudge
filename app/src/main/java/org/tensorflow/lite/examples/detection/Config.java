...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "22424427";
    public static String secretKey = "Fq5YjkKfDRh3EeuLpmiYFLZZ";
    public static String licenseID = "idl-licence-android-face-android";
     ...
     */
    public static String groupID = "18283591";
