...
import org.tensorflow.lite.examples.detection.Config;
import org.tensorflow.lite.examples.detection.ExampleApplication;
...
public class FaceCheckActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.btn_select_next).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
